      ...
      <div className="flex w-56 shrink-0 flex-col border-r border-divider bg-surface">
        <div className="border-b border-divider px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-[family-name:var(--font-display)] text-sm font-bold text-foreground">Cash Book</h2>
          </div>
        </div>
        ...
        <div className="mt-auto border-t border-divider p-4">
          <div className="space-y-2 text-[11px] text-foreground-muted">
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-foreground">{stats.enabled_clients}</span>
            </div>
            <div className="flex justify-between">
              <span>Total Users</span>
              <span className="font-semibold text-foreground">{stats.total_users}</span>
            </div>
            <div className="flex justify-between">
