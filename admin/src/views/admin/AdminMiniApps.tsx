...
export default function AdminMiniApps() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-6">
        <h1 className="font-[family-name:var(--font-display)] text-xl font-bold text-foreground">Mini Apps</h1>
        <p className="mt-1 text-sm text-foreground-muted">Manage mini app visibility and access control</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-lg border border-divider bg-surface py-12 text-center">
          <p className="text-sm text-foreground-dim">No mini apps available yet.</p>
        </div>
      ) : (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {app.description && (
                    <p className="mt-0.5 text-xs text-foreground-dim">{app.description}</p>
                  )}
                  {/* Access summary */}
      ...
      <div className="fixed right-0 top-0 z-50 flex h-full w-[400px] flex-col bg-surface shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-divider px-5 py-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-foreground-dim">Control who can see this app</p>
          </div>
          <button
            onClick={onClose}
