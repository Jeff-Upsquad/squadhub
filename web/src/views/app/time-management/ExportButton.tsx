...
export default function ExportButton({ startDate, endDate }: Props) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-1.5 rounded-lg border border-divider bg-surface px-3 py-2 text-xs font-medium text-foreground-muted transition hover:bg-surface-alt disabled:opacity-50"
    >
