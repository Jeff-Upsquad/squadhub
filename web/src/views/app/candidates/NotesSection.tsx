...
import type { CandidateNote } from '@squadhub/shared';
...
export default function NotesSection({ candidateId }: { candidateId: string }) {
  ...
  const editMutation = useMutation({
    mutationFn: async ({ noteId, content }: { noteId: string; content: string }) => {
      await api.patch(`/candidates/notes/${noteId}`, { content });
    },
  ...
  const deleteMutation = useMutation({
    mutationFn: async (noteId: string) => { await api.delete(`/candidates/notes/${noteId}`); },
