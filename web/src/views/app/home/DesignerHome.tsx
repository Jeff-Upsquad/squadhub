...
export default function DesignerHome({ onOpenInbox }: { onOpenInbox: () => void }) {
    ...
    <div className="sh-view h-full overflow-y-auto">
      <div className="dash">
        <div className="dash-hero">
          <div>
            <div className="eyebrow" style={{ marginBottom: 10 }}>Ready to design, {firstName}</div>
            <h1 className="greeting">Three designs need <em>your review today.</em></h1>
          ...
          <div className="date">
            ...
            <span className="mono" style={{ display: 'block', fontSize: 10, color: 'var(--sh-ink-4)', opacity: 0.8, marginTop: 2 }}>Designer Home</span>
          </div>
        </div>
